<template>
    ...
    <LayoutDashboard>
        ...
        <template v-slot:main>
            <!-- main -->
            <h3 class="fw-bold">My Wishlist</h3>
            <div class="col-12">
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">

                    <div v-for="wish in Wishlist" class="col mt-4">
                        <img :src="getCoverPath(wish.COMIC_COVER)" alt="" class="card-img-top rounded-3">
                        <div class="card-body">
                            <div class="row">
                                <a href="" class="col-9 text-decoration-none" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">
                                    <strong class="fs-5 text-danger">{{ wish.COMIC_GENRE }}</strong><br>
                                    <h5 class="text-dark text-truncate">{{ wish.COMIC_TITLE }}</h5>
                                </a>
                            ...
                            <button class="btn btn-dark w-100" @click="addToCart(comic, $event)">
                                <i class="fa-duotone fa-basket-shopping me-1"></i> Add to Cart
                            </button>
                            <button class="btn btn-dark w-100 mt-2"><i
                                    class="fa-duotone fa-scanner-gun fa-beat-fade me-1"></i> Checkout</button>
                        </div>
                    </div>
